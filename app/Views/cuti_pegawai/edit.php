    ...
    <div class="col-lg-8">
        <div class="card shadow-custom">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-pencil me-2"></i>Edit Cuti Pegawai</h5>
            </div>
            <div class="card-body">
                <form action="<?= base_url('cuti-pegawai/' . $cutiPegawai['id']) ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= (session('errors.nip')) ? 'is-invalid' : '' ?>" id="nip" name="nip" required>
                            ...
                            <?php foreach ($pegawai as $p): ?>
                                <option value="<?= esc($p['nip']) ?>" <?= $cutiPegawai['nip'] == $p['nip'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= (session('errors.nama')) ? 'is-invalid' : '' ?>" id="nama" name="nama" value="<?= esc($cutiPegawai['nama']) ?>" maxlength="50" required readonly>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= (session('errors.jenis_cuti')) ? 'is-invalid' : '' ?>" id="jenis_cuti" name="jenis_cuti" required>
                            ...
                            <?php foreach ($masterCuti as $mc): ?>
                                <option value="<?= esc($mc['kode_cuti']) ?>" <?= $cutiPegawai['jenis_cuti'] == $mc['kode_cuti'] ? 'selected' : '' ?>>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control <?= (session('errors.mulai_cuti')) ? 'is-invalid' : '' ?>" id="mulai_cuti" name="mulai_cuti" value="<?= esc($cutiPegawai['mulai_cuti']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control <?= (session('errors.selesai_cuti')) ? 'is-invalid' : '' ?>" id="selesai_cuti" name="selesai_cuti" value="<?= esc($cutiPegawai['selesai_cuti']) ?>" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control bg-light" id="lama_cuti" name="lama_cuti" value="<?= esc($cutiPegawai['lama_cuti']) ?>" readonly>
...
// Set minimum date for mulai_cuti to today (but allow editing past dates)
